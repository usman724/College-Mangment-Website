...
<div class="row">
  <div class="col-md-12" style="background-image:url('ContactUs.jpg');background-size:cover;height:350px;">
    <div style="width:100%;height:100%;background-color:#001b36a1;">
    <div class="row">
        <h3 class="offset-md-4 col-md-6"style="margin-top:10%;font-size:45px;color:white;">Contact Us</h3>
  ...
  <div class="container-fluid">
    ...
    <div class="row" style="margin-top:50px;">
        <div class="jumbotron  col-md-3" style="margin-left:50px;" >

         <center> <i class="fa fa-map-marker" style="font-size:50px;color:skyblue "></i>
          <br><br>
                   <h4>Islamabad Campus</h4>
                   <pre> A.K. Brohi Road, H-11/4
 Tel: 111 128 128 831 4100-29
 Fax: (051) 410 0619
                 </pre>
         </center>
