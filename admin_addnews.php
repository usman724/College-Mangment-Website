...
if (isset($_POST['sub'])) {
       ...
       if (empty($title)) {
             ...
             $_SESSION['titleerror']="Pease Fill The Field";
              ...
              $_SESSION['deserror']="Pease Fill The Field";
       }
      else
      {
         ...
         $db=mysqli_connect('localhost','root','','college') or die("db not connected");
               ...
               $query= "insert into news (title,des) values ('$title','$des')";
...
<div class="row">
         ...
         <div class="row" style="margin-top:40px;">
           ...
           <div class="offset-md-1 col-md-10 " style="border:1px solid blue;" >
                <form method="POST" action="admin_addnews.php">
                  <h4 class="offset-5">Add News</h4>
                  <p class="offset-5" style="color:green;"><?php echo($_SESSION['success']) ?></p>
  <div class="form-group">
    <label for="email">News Tittle</label>
    <input type="text" class="form-control" id="email" name="title" maxlength="50" placeholder="Less Than 50 Word" >
    <span style="color:red"><?php echo($_SESSION['titleerror']) ?></span>
  </div>
  <div class="form-group">
    <label for="pwd">Description:</label>
    <textarea type="text" class="form-control" id="pwd" name="disp"></textarea>
  </div>
   <p style="color:red"><?php echo($_SESSION['deserror']) ?></p>
 ...
 <div class="offset-md-1 col-md-10 " style="border:1px solid orange;margin-top:30px;" >
                <form method="POST" action="admin_addnews.php">
                  <h4 class="offset-5">Delete News</h4>
